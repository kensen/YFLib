...
{
    [Serializable]
    public class IQCLog4netLogger : MarshalByRefObject, Logger
    {
        private static readonly Type declaringType = typeof(IQCLog4netLogger);

        public IQCLog4netLogger(log4net.Core.ILogger logger, IQCLog4netFactory factory)
        {
            Logger = logger;
            Factory = factory;
        }

        internal IQCLog4netLogger()
        {
        }

        internal IQCLog4netLogger(ILog log, IQCLog4netFactory factory)
        ...
        protected internal IQCLog4netFactory Factory { get; set; }
