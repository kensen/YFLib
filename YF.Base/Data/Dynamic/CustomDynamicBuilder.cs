...
namespace YF.Base.Data.Dynamic
{
    /// <summary>
    /// 通过 Emit 动态创建类
    /// </summary>
    public class CustomDynamicBuilder
    {
        ...
        /// <param name="lm"></param>
        /// <returns></returns>
        public static Type DynamicCreateType(string className, IList<DynamicPropertyModel> lm,Type parent=null)
        {
            //动态创建程序集
            ...
            AssemblyBuilder dynamicAssembly=AssemblyBuilder.DefineDynamicAssembly(new AssemblyName(Guid.NewGuid().ToString()),AssemblyBuilderAccess.Run );
            //动态创建模块
