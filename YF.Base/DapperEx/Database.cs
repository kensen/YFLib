...
namespace Dapper
{
    ...
    public abstract partial class Database<TDatabase> : IDisposable where TDatabase : Database<TDatabase>, new()
    {
        public partial class Table<T, TId>
        {
            ...
            /// <returns></returns>
            public virtual int? Insert(dynamic data,bool autoId=true)
            {
                var o = (object)data;       
            ...
            public virtual int? InsertReturnId(dynamic data,bool autoId=true)
            {
                var o = (object)data;
            ...
            /// <returns></returns>
            public virtual int Update(TId id, dynamic data)
            {
        ...
        public DataTable QuerySqlServerDataTable(string sql, CommandType commandType,dynamic param = null)
        {
